...
aggregated as in the upper table, it can always be disaggregated to resemble 
the one in the lower table. So what's the problem? 
...
Let's visualize the mean of the probability of dying well as the HDI for
